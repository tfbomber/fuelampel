...
const translations = {
  de: {
    ...
    tankLowAlert:      '⚠️  Tank wird knapp — hast du zwischenzeitlich getankt?',
    ...
    errorTitle:           'Fehler',
    // Settings v4 — Minimalist redesign
    settingsBasics:        'Basis',
    settingsSmartTanken:   'Smart Tanken',
    settingsAdvanced:      'Erweitert',
    settingsAbout:         'Über',
    settingsDangerZone:    'Gefahrenzone',
    fuelTypeShort:         'Spritsorte',
    homeShort:             'Zuhause',
    workShort:             'Arbeit',
    ...
    rangeShort:            'Reichweite',
    refuelStyleConvenient: 'Unterwegs',
    refuelStyleNearEmpty2: 'Erst leer',
    refuelStyleCheapest2:  'Preis-Jäger',
    versionLabel:          'Version',
    editValue:             'Wert ändern',
    alertOdometerRange:    '0 – 999.999 km',
    onboardingOdometerTitle: 'Aktueller Tachostand (optional)',
    onboardingOdometerHint:  'Gib deinen km-Stand ein, damit wir deinen Verbrauch genau lernen können.',
    onboardingCommuteDaysLabel: 'Arbeitstage pro Woche',
    smartTankOff:          'AUS',
    smartTankOn:           'AN',
  },
  en: {
    ...
    tankLowAlert:      '⚠️  Tank is getting low — have you refueled recently?',
    yesReset:          'Yes, reset',
    undoLabel:         '↺ Undo',
    ...
    rangeShort:            'Range',
    refuelStyleConvenient: 'On Route',
    refuelStyleNearEmpty2: 'When Empty',
    refuelStyleCheapest2:  'Price Hunter',
    versionLabel:          'Version',
    editValue:             'Edit Value',
    alertOdometerRange:    '0 – 999,999 km',
    onboardingOdometerTitle: 'Current Odometer (optional)',
    onboardingOdometerHint:  'Enter your km reading so we can learn your fuel consumption accurately.',
    onboardingCommuteDaysLabel: 'Work days per week',
    smartTankOff:          'OFF',
    smartTankOn:           'ON',
  },
} as const;
